...
def train(data_address,data_name,vector_address=None, vocab_address=None, embd_dimension =2, train_splitThreshold=0.7,
          time_unit='day', batch_size=20, start_pos=3, stop_pos=8, length_size=3, prefix_minLength=0, prefix_maxLength=None,
...
train('/Users/caorui/Desktop/RemainTimePrediction-master/data/BPIC_2012_O_Del.csv', data_name='BPIC_2012_O_Del',
