...
def train(data_address,data_name,vector_address=None, vocab_address=None, embd_dimension =2, train_splitThreshold=0.7,
          time_unit='month', batch_size=20, start_pos=3, stop_pos=9, length_size=3, prefix_minLength=0, prefix_maxLength=None,
          loss_type= 'L1Loss', optim_type= 'Adam', model_type='LSTM', hidden_dim=5,
...
train('/Users/caorui/Desktop/RemainTimePrediction-master/data/Road_Traffic_Fine_Management_P.csv', data_name='Road_Traffic_Fine_Management_P',
